...
public class Exercise_2 {
    ...
    private static class sendMsg extends AbstractFunction1<EdgeTriplet<Integer,Integer>, Iterator<Tuple2<Object,Integer>>> implements Serializable {
        ...
        public Iterator<Tuple2<Object, Integer>> apply(EdgeTriplet<Integer, Integer> triplet) {
            ...
            if (Integer.parseInt(sourceVertex._2.toString()) != Integer.MAX_VALUE) {
                sourceVertexPlusDistance = Integer.parseInt(sourceVertex._2.toString()) + distance;
            }

            if (sourceVertexPlusDistance < dstVertex._2) {
                return JavaConverters.asScalaIteratorConverter(Arrays.asList(new Tuple2<Object,Integer>(triplet.dstId(), sourceVertexPlusDistance)).iterator()).asScala();
            }
            else return JavaConverters.asScalaIteratorConverter(Arrays.asList(new Tuple2<Object,Integer>(triplet.dstId(), dstVertex._2)).iterator()).asScala();
        }
    }
